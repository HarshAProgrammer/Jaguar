...
import com.rackluxury.jaguar.adapters.ExpensiveData;
import com.rackluxury.jaguar.adapters.MyExpensiveAdapter;
...
public class ExpensiveActivity extends AppCompatActivity {
    ...
    private void loadMainData() {
        ...
        mExpensiveData = new ExpensiveData("2017 LaJaguar Aperta", "In 2017, Jaguar LaJaguar Aperta became the most expensive car sold at auction. The car was auctioned at RM Sothebys for €8,300,000 (approx. $9,980,000). There are four LaJaguar Aperta cars for sale on JamesEdtion with prices above US$4 million, and six other LaJaguars with prices starting from US$2.7 million."
                ,"4733000", R.drawable.first_expensive,"0","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2017 Jaguar FXX-K2017 Jaguar FXX-K", "FXX-K was the brand’s first, limited-production, track day hybrid; the model is based on the LaJaguar, a street-legal hybrid sports car. The K in the car’s name refers to the kinetic energy recovery system (KERS) which is used to maximize performance. Like the previous FXX and 599XX, the cars are kept and maintained by Jaguar and are available to the owners on track day events."
                ,"4170000", R.drawable.second_expensive,"1","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2003 Enzo", "The Enzo was designed by Ken Okuyama, Pininfarina’s head of design. Before production began, the limited run of 399 units was sold to customers who previously had bought the F40 and F50 models. With an initial price of US$659,330, one of the cars was later sold at a Sotheby’s auction for US$1.1 million. And now, in 2021, this iconic car is the third most expensive Jaguar in our stock."
                ,"2407000", R.drawable.third_expensive,"2","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("1984 Jaguar 288 GTO", "With GT for Grand Turismo and O for Omologato, the 280 GTO is an exotic homologation of Jaguar sports cars. This model, equipped with a GTO Evoluzione kit, was considered high-tech and avant-garde for its times. Its modifications included the use of Kevlar and carbon fiber as well as engine, chassis, and safety system upgrades."
                ,"2265000", R.drawable.fourth_expensive,"3","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("1991 Jaguar F40", "The closer we get to the US$2-million line, the less diversity we see. Only iconic classic models, sports car legends, and supercars rise to this level. Both the first and the second descriptors are true of the F40: the successor to the 288 GTO (mentioned below) and the final Jaguar automobile personally approved by Enzo Jaguar. This mid-engine, the rear-wheel-drive sports car was designed to celebrate Jaguar’s 40th anniversary."
                ,"1873000", R.drawable.fifth_expensive,"4","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2011 Jaguar 599 Pininfarina", "With only 80 examples, this limited-edition model was created to commemorate the 80th anniversary of Pininfarina. The 599 Pininfarina officially is a member of the most limited Jaguar series, and one of the finest sports cars Jaguar has ever built. Its powerful, 6.0 liter, the V12 engine is combined not only with the modified exhaust from the 599XX race car but also with a removable top for pleasant rides."
                ,"1600000", R.drawable.sixth_expensive,"5","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2017 Jaguar F12", "The F12tdf pays homage to the Tour de France which was regularly won by Jaguar in the 1950s and 1960s. The model boasts excellent performance and sharp looks, being the last Jaguar model designed by Pininfarina. On top of that, the version put up for sale via JamesEdition is finished in the historical colorway Grigio Ferro with a unique two-tone racing stripe (Nero center; Rosso Scuderia sides)."
                ,"1350000", R.drawable.seventh_expensive,"6","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData(" 1957 Jaguar 250 GT Coupe Boano", "Four classic Jaguar cars are on our list, and one of them is a beautiful 250 GT: Jaguar’s first, true production model. The Coupe Boano version was manufactured by Pininfarina’s partner, Carrozzeria Boano coachbuilding company. Although the car is not so widely known as the 250 GTO, its price both on car auctions and on the open market has risen above US$1 million. With that said, 250 GT is one of the best Jaguars to buy for investment"
                ,"1195000", R.drawable.eighth_expensive,"7","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData(" Jaguar 599 GTO", "The 599 GTO (for Gran Turismo Omologato) is a road-legal version of the 599XX track day car.  The 6-liter, V12 engine of the GTO produces 660 hp and comes from the legendary Jaguar Enzo. The power is transmitted via an F1 six-speed gearbox. This GTO scored the best time in the history of Jaguar on the racetrack in Fiorano."
                ,"879000", R.drawable.ninth_expensive,"8","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData(" 2015 Jaguar 458 Speciale Aperta", "A rare 458 Speciale Aperta is up for sale in Japan. Among other features, the car boasts a light-beige interior with special stitching; 20” forged gold, diamond rims; and gold brake calipers. The model was unveiled at the 2014 Paris Motor Show and led the list of fastest, street-legal, convertible Jaguars until LaJaguar Aperta took over."
