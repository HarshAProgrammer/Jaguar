...
import com.rackluxury.jaguar.youtube.model.PlaylistVideos;
...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    private final com.rackluxury.jaguar.youtube.YouTubeRecyclerViewFragment.LastItemReachedListener mListener;
    ...
    public PlaylistCardAdapter(PlaylistVideos playlistVideos, com.rackluxury.jaguar.youtube.YouTubeRecyclerViewFragment.LastItemReachedListener lastItemReachedListener) {
